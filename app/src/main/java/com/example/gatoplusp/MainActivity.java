...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    Button Btn_1,Btn_2,Btn_3,Btn_4,Btn_5,Btn_6,Btn_7,Btn_8,Btn_9,
            Btn_10,Btn_11,Btn_12,Btn_13,Btn_14,Btn_15,Btn_16,Btn_17,
            Btn_18,Btn_19,Btn_20,Btn_21,Btn_22,Btn_23,Btn_24,Btn_25,
            Btn_26,Btn_27,Btn_28,Btn_29,Btn_30,Btn_31,Btn_32,Btn_33,
            Btn_34,Btn_35,Btn_36,Btn_Salir,Btn_Reset;
    ...
    public void Ganador(char letra){
        ...
        if(Btn_1.getText().toString().equals(letra+"") && (Btn_2.getText().toString().equals(letra+"")) && (Btn_3.getText().toString().equals(letra+"")) && (Btn_4.getText().toString().equals(letra+""))){
        ...
        }else if(Btn_3.getText().toString().equals(letra+"") && (Btn_4.getText().toString().equals(letra+"")) && (Btn_5.getText().toString().equals(letra+"")) && (Btn_6.getText().toString().equals(letra+""))){
            Et_Ganador.setText("El ganador es "+letra);
            Et_Ganador.setEnabled(false);
            Btn_1.setEnabled(false);
            Btn_2.setEnabled(false);
        ...
        }else if(Btn_7.getText().toString().equals(letra+"") && (Btn_8.getText().toString().equals(letra+"")) && (Btn_9.getText().toString().equals(letra+"")) && (Btn_10.getText().toString().equals(letra+""))){
            Et_Ganador.setText("El ganador es "+letra);
            Et_Ganador.setEnabled(false);
            Btn_1.setEnabled(false);
            Btn_2.setEnabled(false);
        ...
        }else if(Btn_9.getText().toString().equals(letra+"") && (Btn_10.getText().toString().equals(letra+"")) && (Btn_11.getText().toString().equals(letra+"")) && (Btn_12.getText().toString().equals(letra+""))){
            Et_Ganador.setText("El ganador es "+letra);
            Et_Ganador.setEnabled(false);
            Btn_1.setEnabled(false);
            Btn_2.setEnabled(false);
        ...
        }else if(Btn_13.getText().toString().equals(letra+"") && (Btn_14.getText().toString().equals(letra+"")) && (Btn_15.getText().toString().equals(letra+"")) && (Btn_16.getText().toString().equals(letra+""))){
            Et_Ganador.setText("El ganador es "+letra);
            Et_Ganador.setEnabled(false);
            Btn_1.setEnabled(false);
            Btn_2.setEnabled(false);
        ...
        }else if(Btn_15.getText().toString().equals(letra+"") && (Btn_16.getText().toString().equals(letra+"")) && (Btn_17.getText().toString().equals(letra+"")) && (Btn_18.getText().toString().equals(letra+""))){
            Et_Ganador.setText("El ganador es "+letra);
            Et_Ganador.setEnabled(false);
            Btn_1.setEnabled(false);
            Btn_2.setEnabled(false);
        ...
        }else if(Btn_19.getText().toString().equals(letra+"") && (Btn_20.getText().toString().equals(letra+"")) && (Btn_21.getText().toString().equals(letra+"")) && (Btn_22.getText().toString().equals(letra+""))){
            Et_Ganador.setText("El ganador es "+letra);
            Et_Ganador.setEnabled(false);
            Btn_1.setEnabled(false);
            Btn_2.setEnabled(false);
        ...
        }else if(Btn_21.getText().toString().equals(letra+"") && (Btn_22.getText().toString().equals(letra+"")) && (Btn_23.getText().toString().equals(letra+"")) && (Btn_24.getText().toString().equals(letra+""))){
            Et_Ganador.setText("El ganador es "+letra);
            Et_Ganador.setEnabled(false);
            Btn_1.setEnabled(false);
            Btn_2.setEnabled(false);
        ...
        }else if(Btn_25.getText().toString().equals(letra+"") && (Btn_26.getText().toString().equals(letra+"")) && (Btn_27.getText().toString().equals(letra+"")) && (Btn_28.getText().toString().equals(letra+""))){
            Et_Ganador.setText("El ganador es "+letra);
            Et_Ganador.setEnabled(false);
            Btn_1.setEnabled(false);
            Btn_2.setEnabled(false);
        ...
        }else if(Btn_27.getText().toString().equals(letra+"") && (Btn_28.getText().toString().equals(letra+"")) && (Btn_29.getText().toString().equals(letra+"")) && (Btn_30.getText().toString().equals(letra+""))){
            Et_Ganador.setText("El ganador es "+letra);
            Et_Ganador.setEnabled(false);
            Btn_1.setEnabled(false);
            Btn_2.setEnabled(false);
        ...
        }else if(Btn_31.getText().toString().equals(letra+"") && (Btn_32.getText().toString().equals(letra+"")) && (Btn_33.getText().toString().equals(letra+"")) && (Btn_34.getText().toString().equals(letra+""))){
            Et_Ganador.setText("El ganador es "+letra);
            Et_Ganador.setEnabled(false);
            Btn_1.setEnabled(false);
            Btn_2.setEnabled(false);
        ...
        }else if(Btn_33.getText().toString().equals(letra+"") && (Btn_34.getText().toString().equals(letra+"")) && (Btn_35.getText().toString().equals(letra+"")) && (Btn_36.getText().toString().equals(letra+""))){
            Et_Ganador.setText("El ganador es "+letra);
            Et_Ganador.setEnabled(false);
            Btn_1.setEnabled(false);
            Btn_2.setEnabled(false);
        ...
        }else if(Btn_1.getText().toString().equals(letra+"") && (Btn_7.getText().toString().equals(letra+"")) && (Btn_13.getText().toString().equals(letra+"")) && (Btn_19.getText().toString().equals(letra+""))){
            Et_Ganador.setText("El ganador es "+letra);
            Et_Ganador.setEnabled(false);
            Btn_2.setEnabled(false);
            Btn_3.setEnabled(false);
        ...
        }else if(Btn_13.getText().toString().equals(letra+"") && (Btn_19.getText().toString().equals(letra+"")) && (Btn_25.getText().toString().equals(letra+"")) && (Btn_31.getText().toString().equals(letra+""))){
            Et_Ganador.setText("El ganador es "+letra);
            Et_Ganador.setEnabled(false);
            Btn_1.setEnabled(false);
            Btn_2.setEnabled(false);
        ...
        }else if(Btn_2.getText().toString().equals(letra+"") && (Btn_8.getText().toString().equals(letra+"")) && (Btn_14.getText().toString().equals(letra+"")) && (Btn_20.getText().toString().equals(letra+""))){
            Et_Ganador.setText("El ganador es "+letra);
            Et_Ganador.setEnabled(false);
            Btn_1.setEnabled(false);
            Btn_3.setEnabled(false);
        ...
        }else if(Btn_14.getText().toString().equals(letra+"") && (Btn_20.getText().toString().equals(letra+"")) && (Btn_26.getText().toString().equals(letra+"")) && (Btn_32.getText().toString().equals(letra+""))){
            Et_Ganador.setText("El ganador es "+letra);
            Et_Ganador.setEnabled(false);
            Btn_1.setEnabled(false);
            Btn_2.setEnabled(false);
        ...
        }else if(Btn_3.getText().toString().equals(letra+"") && (Btn_9.getText().toString().equals(letra+"")) && (Btn_15.getText().toString().equals(letra+"")) && (Btn_21.getText().toString().equals(letra+""))){
            Et_Ganador.setText("El ganador es "+letra);
            Et_Ganador.setEnabled(false);
            Btn_1.setEnabled(false);
            Btn_2.setEnabled(false);
        ...
        }else if(Btn_15.getText().toString().equals(letra+"") && (Btn_21.getText().toString().equals(letra+"")) && (Btn_27.getText().toString().equals(letra+"")) && (Btn_33.getText().toString().equals(letra+""))){
            Et_Ganador.setText("El ganador es "+letra);
            Et_Ganador.setEnabled(false);
            Btn_1.setEnabled(false);
            Btn_2.setEnabled(false);
        ...
        }else if(Btn_4.getText().toString().equals(letra+"") && (Btn_10.getText().toString().equals(letra+"")) && (Btn_16.getText().toString().equals(letra+"")) && (Btn_22.getText().toString().equals(letra+""))){
            Et_Ganador.setText("El ganador es "+letra);
            Et_Ganador.setEnabled(false);
            Btn_1.setEnabled(false);
            Btn_2.setEnabled(false);
        ...
        }else if(Btn_16.getText().toString().equals(letra+"") && (Btn_22.getText().toString().equals(letra+"")) && (Btn_28.getText().toString().equals(letra+"")) && (Btn_34.getText().toString().equals(letra+""))){
            Et_Ganador.setText("El ganador es "+letra);
            Et_Ganador.setEnabled(false);
            Btn_1.setEnabled(false);
            Btn_2.setEnabled(false);
        ...
        }else if(Btn_5.getText().toString().equals(letra+"") && (Btn_11.getText().toString().equals(letra+"")) && (Btn_17.getText().toString().equals(letra+"")) && (Btn_23.getText().toString().equals(letra+""))){
            Et_Ganador.setText("El ganador es "+letra);
            Et_Ganador.setEnabled(false);
            Btn_1.setEnabled(false);
            Btn_2.setEnabled(false);
        ...
        }else if(Btn_17.getText().toString().equals(letra+"") && (Btn_23.getText().toString().equals(letra+"")) && (Btn_29.getText().toString().equals(letra+"")) && (Btn_35.getText().toString().equals(letra+""))){
            Et_Ganador.setText("El ganador es "+letra);
            Et_Ganador.setEnabled(false);
            Btn_1.setEnabled(false);
            Btn_2.setEnabled(false);
        ...
        }else if(Btn_6.getText().toString().equals(letra+"") && (Btn_12.getText().toString().equals(letra+"")) && (Btn_18.getText().toString().equals(letra+"")) && (Btn_24.getText().toString().equals(letra+""))){
            Et_Ganador.setText("El ganador es "+letra);
            Et_Ganador.setEnabled(false);
            Btn_1.setEnabled(false);
            Btn_2.setEnabled(false);
        ...
        }else if(Btn_18.getText().toString().equals(letra+"") && (Btn_24.getText().toString().equals(letra+"")) && (Btn_30.getText().toString().equals(letra+"")) && (Btn_36.getText().toString().equals(letra+""))){
            Et_Ganador.setText("El ganador es "+letra);
            Et_Ganador.setEnabled(false);
            Btn_1.setEnabled(false);
            Btn_2.setEnabled(false);
